<section id="home" class="relative min-h-screen flex items-center overflow-hidden pt-20">
  <div class="absolute inset-0 overflow-hidden pointer-events-none">
    <div class="absolute -top-40 -right-40 w-96 h-96 bg-accent/10 rounded-full blur-3xl animate-blob"></div>
    <div class="absolute -bottom-40 -left-40 w-96 h-96 bg-accent/5 rounded-full blur-3xl animate-blob-delayed"></div>
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-accent/3 rounded-full blur-3xl animate-pulse-glow"></div>
  </div>

  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
    <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
      <div class="space-y-8" x-data="scrollReveal" x-bind:class="visible ? 'animate-fade-up' : 'opacity-0'">
        <div class="space-y-4">
        ...
        <div class="flex items-center gap-4 pt-4">
          ...
          <div class="flex gap-3">
            <a href="https://github.com/RikzaALL" target="_blank" rel="noopener noreferrer" class="p-2.5 text-secondary hover:text-primary hover:bg-white/5 rounded-xl transition-all" aria-label="GitHub">
            ...
            <a href="https://www.linkedin.com/in/rikza-alif-muharom-a20a49387/" target="_blank" rel="noopener noreferrer" class="p-2.5 text-secondary hover:text-primary hover:bg-white/5 rounded-xl transition-all" aria-label="LinkedIn">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </a>
            <a href="https://instagram.com/rkz_mhrm" target="_blank" rel="noopener noreferrer" class="p-2.5 text-secondary hover:text-primary hover:bg-white/5 rounded-xl transition-all" aria-label="Instagram">
            ...
            <a href="mailto:alifrikza45@gmail.com" class="p-2.5 text-secondary hover:text-primary hover:bg-white/5 rounded-xl transition-all" aria-label="Email">
      ...
      <div class="hidden lg:flex justify-center items-center" x-data="scrollReveal" x-bind:class="visible ? 'animate-fade-right' : 'opacity-0'">
        <div class="relative">
