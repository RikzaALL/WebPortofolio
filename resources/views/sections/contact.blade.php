  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto text-center" x-data="scrollReveal" x-bind:class="visible ? 'animate-fade-up' : 'opacity-0'">
      ...
      <div class="flex flex-wrap justify-center gap-4">
        <a
          href="https://wa.me/6287715333749"
          target="_blank"
          rel="noopener noreferrer"
          class="inline-flex items-center gap-2.5 px-6 py-3.5 bg-accent hover:bg-hover text-white font-medium rounded-2xl transition-all duration-300 hover:shadow-lg hover:shadow-accent/25 hover:-translate-y-0.5 text-sm"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>
          WhatsApp
        </a>
        <a
          href="mailto:alifrikza45@gmail.com"
          class="inline-flex items-center gap-2.5 px-6 py-3.5 glass-light text-primary font-medium rounded-2xl transition-all duration-300 hover:bg-white/10 hover:-translate-y-0.5 text-sm"
        >
        ...
        <a
          href="https://github.com/RikzaALL"
          target="_blank"
          rel="noopener noreferrer"
          class="inline-flex items-center gap-2.5 px-6 py-3.5 glass-light text-primary font-medium rounded-2xl transition-all duration-300 hover:bg-white/10 hover:-translate-y-0.5 text-sm"
        >
        ...
        <a
          href="https://www.linkedin.com/in/rikza-alif-muharom-a20a49387/"
          target="_blank"
          rel="noopener noreferrer"
          class="inline-flex items-center gap-2.5 px-6 py-3.5 glass-light text-primary font-medium rounded-2xl transition-all duration-300 hover:bg-white/10 hover:-translate-y-0.5 text-sm"
        >
